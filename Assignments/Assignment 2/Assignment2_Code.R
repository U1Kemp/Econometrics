...
# past use
sum(dummy_copy$q57=='Yes')
mean(dummy_copy$q57=='Yes')*100

# male
sum(dummy_copy$sex=="Male")
mean(dummy_copy$sex=="Male")*100

# education
## below bachelor
sum(dummy_copy$educ2 == 'Some College' | dummy_copy$educ2 == "Associate Degree")
mean(dummy_copy$educ2 == 'Some College' | dummy_copy$educ2 == "Associate Degree")*100

## high school and below
sum(dummy_copy$educ2 == 'HS' | dummy_copy$educ2 == 'Less than HS' 
    | dummy_copy$educ2 == 'HS Incomplete')
mean(dummy_copy$educ2 == 'HS' | dummy_copy$educ2 == 'Less than HS' 
    | dummy_copy$educ2 == 'HS Incomplete')*100

## bachelors and above
sum(dummy_copy$educ2 == "Postgraduate Degree" | dummy_copy$educ2 == "Four year college"
    | dummy_copy$educ2 == "Some Postgraduate")
mean(dummy_copy$educ2 == "Postgraduate Degree" | dummy_copy$educ2 == "Four year college"
    | dummy_copy$educ2 == "Some Postgraduate")*100
...
mean(dummy_copy$party == "Republican")*100

## Democrat
sum(dummy_copy$party == "Democrat")
mean(dummy_copy$party == "Democrat")*100

## Independent and others
sum(dummy_copy$party != "Democrat" & dummy_copy$party != "Republican")
mean(dummy_copy$party != "Democrat" & dummy_copy$party != "Republican")*100

# Religion
## Christian
sum(dummy_copy$relig == "Christian (VOL.)")
mean(dummy_copy$relig == "Christian (VOL.)")*100

## Roman Catholic
sum(dummy_copy$relig == "Roman Catholic (Catholic)")
mean(dummy_copy$relig == "Roman Catholic (Catholic)")*100

## Protestant
sum(dummy_copy$relig == "Protestant (Baptist, Methodist, Non-denominational, Lutheran, Presbyterian, Pentecostal, Episcopalian, Reformed, etc.)")
mean(dummy_copy$relig == "Protestant (Baptist, Methodist, Non-denominational, Lutheran, Presbyterian, Pentecostal, Episcopalian, Reformed, etc.)")*100

## Liberal
sum(dummy_copy$relig == "Agnostic (not sure if there is a God)"
...
mean(dummy_copy$relig == "Agnostic (not sure if there is a God)"
    | dummy_copy$relig == "Nothing in particular" 
    | dummy_copy$relig == "Atheist (do not believe in God)"
    | dummy_copy$relig == "Unitarian (Universalist) (VOL.)")*100

## Conservative
sum(dummy_copy$relig == "Mormon (Church of Jesus Christ of Latter-day Saints/LDS)"
...
mean(dummy_copy$relig == "Mormon (Church of Jesus Christ of Latter-day Saints/LDS)"
    | dummy_copy$relig == "Jewish (Judaism)"
    | dummy_copy$relig == "Hindu"
    | dummy_copy$relig == "Buddhist"
    | dummy_copy$relig == "Muslim (Islam)"
...
# Public Opinion
## Medicinal
sum(dummy_copy$q46 == "medicinal")
mean(dummy_copy$q46 == "medicinal")*100

## NotLegal
sum(dummy_copy$q46 == "notlegal")
mean(dummy_copy$q46 == "notlegal")*100

## Personal use
sum(dummy_copy$q46 == "personal")
mean(dummy_copy$q46 == "personal")*100
